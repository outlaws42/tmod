...
def decrypt(key: str, fname: str, e_fname: str, fdest: str = "relative"):
    """
    ...
    save_file(fname=fname, content=decrypt_file, fdest=fdest, mode="wb")
...
# file information
def check_file_age(fname: str, fdest: str = "relative"):
    """
